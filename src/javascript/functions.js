...
function activate_dark_mode(){
  ...
  icon_dark_mode.setAttribute("src", "/assets/svg/sol_gris.svg")
  menu_desplegable_img.setAttribute("src", "/assets/svg/menu2.svg")
...
function activate_light_mode(){
  ...
  icon_dark_mode.setAttribute("src", "/assets/svg/sun_light.svg")
  menu_desplegable_img.setAttribute("src", "/assets/svg/menu.svg")
...
function picture_mobile (){
  if (window.innerWidth <= 380){
    header__imagen.setAttribute("src", "/assets/img/picture.jpg")
  }else {
    header__imagen.setAttribute("src", "/assets/img/mapas.jpg")
  }
}
